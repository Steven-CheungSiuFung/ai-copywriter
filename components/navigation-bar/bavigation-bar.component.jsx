        ...
        <header className="sticky top-0 z-50 bg-white shadow-[0_4px_6px_rgba(0,0,0,0.1)]">
            <nav className="container mx-auto h-20 px-4 py-3 flex justify-between items-center">
                <div className="flex space-x-3">
                    ...
                    <Link href="/" className="text-[#030303] text-2xl font-poppins font-bold leading-8">
                        CopyGenius
                    </Link>
                </div>
                <div className="flex space-x-6">
                    <Link href="/chat" className="text-[#030303] text-base font-sans leading-6">
                        AI-Chat
                    </Link>
                    <Link href="/copywriter-generator" className="text-[#030303] text-base font-sans leading-6">
                        Copywriter Generator
                    </Link>
                    <Link href="/image-generator" className="text-[#030303] text-base font-sans leading-6">
                        Image Generator
                    </Link>
                </div>
            </nav>
